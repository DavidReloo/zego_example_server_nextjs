...
export default async function sendGift(req, resp) {
  ...
  const url = `https://rtc-api.zego.im/?Action=SendCustomCommand&AppId=${app_id}&Timestamp=${serverTimeStamp}&Signature=${signature}&SignatureVersion=2.0&SignatureNonce=${signatureNonce}&RoomId=${room_id}&FromUserId=${user_id}&MessageContent=${message}`;
